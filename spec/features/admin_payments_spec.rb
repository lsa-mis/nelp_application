...
RSpec.describe "Admin::Payments", type: :feature do
  ...
  let!(:payment) { FactoryBot.create(:payment, user: user, total_amount: '12345', transaction_type: '1', transaction_status: '1', program_year: Date.current.year) }
  ...
  describe "edit payment form" do
    it "shows persisted values and updates payment" do
      ...
      fill_in "Total amount", with: 20000
